...
cp "$SCRIPT_DIR/decrypt_gui.py" "$APPDIR/usr/bin/"
cp "$SCRIPT_DIR/start_gui.sh" "$APPDIR/usr/bin/"
cp "$SCRIPT_DIR/batch_cia_3ds_decryptor.sh" "$APPDIR/usr/bin/"
cp "$SCRIPT_DIR/README_GUI.md" "$APPDIR/usr/share/"
cp "$SCRIPT_DIR/README_LINUX.md" "$APPDIR/usr/share/"

# Copy decryption tools
echo "🔧 Copying decryption tools..."
cp "$SCRIPT_DIR/decrypt.exe" "$APPDIR/usr/bin/"
cp "$SCRIPT_DIR/ctrtool.exe" "$APPDIR/usr/bin/"
cp "$SCRIPT_DIR/makerom.exe" "$APPDIR/usr/bin/"
