...
class Decrypt3DSGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("3DS/CIA Decryptor")
        ...
        self.config_file = os.path.join(self.decryptor_path, ".gui_config")
    ...
    def create_widgets(self):
        ...
        title_label = tk.Label(title_frame, text="🎮 3DS/CIA File Decryptor", 
    ...
    def copy_log(self):
        ...
        try:
            ...
            self.log_text.clipboard_append(self.log_text.get("1.0", tk.END))
    ...
    def decrypt_file(self, file_path):
        try:
            ...
            subprocess.run(['cp', file_path, self.decryptor_path], check=True)
            ...
            process = subprocess.run(
                ...
                capture_output=True,
                text=True,
                input='\n'  # Send enter to skip the "press any key to exit" prompt
            )
            ...
            if process.returncode == 0:
                ...
                self.progress_label.config(text="Moving decrypted files...", fg="orange")
                ...
                if os.path.exists(original_copy):
                    subprocess.run(['rm', original_copy])
                ...
                self.progress_label.config(text="Decryption Failed!", fg="red")
